(function() {
  ...
  describe('Part I', function() {
    ...
    describe('uniq', function() {
      ...
      it('should handle iterators that work with a sorted array', function() { // iterator is changing (pseudo-mapping ie if you were to map) numbers after applying a test to either true or false
        var iterator = function(value) { return value === 1; }; // unique removes the duplicate true and falses 
